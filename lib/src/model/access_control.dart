...
class AppPasswordAccessControl extends AccessControl {
  ...
  AppPasswordAccessControl._(
      {required this.password,
      required String tag,
      required List<AccessControlOption> options})
      : super._(options: options, tag: tag);

  factory AppPasswordAccessControl(
  ...
  factory AppPasswordAccessControl.fromJson(Map<String, dynamic> json) =>
      _$AppPasswordAccessControlFromJson(json);
