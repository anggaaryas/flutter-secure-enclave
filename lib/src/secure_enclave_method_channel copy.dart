...
//       {required String message, required String tag}) async {
...
//   Future<MethodResult<Uint8List?>> encryptWithPublicKey(
//       {required String message, required String? publicKeyString}) async {
//     final result = await methodChannel.invokeMethod<dynamic>(
//         "encryptWithCustomPublicKey",
...
//     final result =
//         await methodChannel.invokeMethod<dynamic>('getPublicKeyString', {
//       "tag": tag,
//     });
